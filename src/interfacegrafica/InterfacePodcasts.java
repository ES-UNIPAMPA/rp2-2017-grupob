 ...
 */
public class InterfacePodcasts extends javax.swing.JFrame {
    ...
    private IGerenciador gPodcasts = null;
    private DefaultTableModel modelTabMidias;

    /**
     * Creates new form Home
     */
    public InterfacePodcasts() {
        initComponents();
        gPodcasts = GPodcasts.getInstance();
    ...
    private void initComponents() {
        ...
        editAutores = new javax.swing.JTextArea();
        ...
        txtCatalogodeMidias.setText("Catálogo de Podcasts");
        ...
        txtFotografo.setText("AUTORES:");
        jPCadastrar.add(txtFotografo, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 180, -1, -1));
        ...
        jPCadastrar.add(txtPessoas, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 180, -1, -1));
        ...
        jPCadastrar.add(editIdioma, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 210, 190, 40));
        ...
        jPCadastrar.add(txtLocal2, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 180, -1, -1));

        editAutores.setBackground(new java.awt.Color(187, 187, 187));
        editAutores.setColumns(20);
        editAutores.setRows(5);
        jScrollPane3.setViewportView(editAutores);
        ...
        jPCadastrar.add(editAno, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 210, 160, 40));
    ...
    private void btnSalvarArquivoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSalvarArquivoMouseClicked
        ...
        if (path != null) {
            if (gPodcasts.salvarArquivo(path)) {
    ...
    private void btnCarregarArquivoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCarregarArquivoMouseClicked
        String path = getPathFile();
        if (path != null) {
            if (gPodcasts.carregarArquivo(path)) {
    ...
    private void btnPesquisarMidiaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPesquisarMidiaMouseClicked
        if (editConsultar.getText().trim().equals("")) {
            ...
            Podcast aux = (Podcast) gPodcasts.consultar(editConsultar.getText());
    ...
    private void btnAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddMouseClicked
        if ((editCaminho.getText().trim().equals("") || editTitulo.getText().trim().equals(""))
                ...
                || editAutores.getText().trim().equals("") || editAno.getText().trim().equals("")) {
    ...
    private void btnAtualizarMidiasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAtualizarMidiasMouseClicked
        if (jTable.getSelectedRow() == -1) {
            ...
            if (midiaNova != null) {
                if (gPodcasts.editar(midiaVelha, midiaNova)) {
    ...
    private javax.swing.JTextArea editAutores;
