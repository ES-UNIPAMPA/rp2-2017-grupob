...
public class InterfaceFilmes extends javax.swing.JFrame {
     ...
     */
    public InterfaceFilmes() {
        initComponents();
        gFilmes = GFilmes.getInstance();
    ...
    private void initComponents() {
        ...
        editDiretor = new javax.swing.JTextField();
        ...
        txtLocal2 = new javax.swing.JLabel();
        txtFotografo1 = new javax.swing.JLabel();
        jScrollPane3 = new javax.swing.JScrollPane();
        editAtores = new javax.swing.JTextArea();
        editAno = new javax.swing.JFormattedTextField();
        ...
        txtCatalogodeMidias.setText("Catálogo de Filmes");
        ...
        txtFotografo.setText("ATORES:");
        jPCadastrar.add(txtFotografo, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 300, -1, -1));

        txtPessoas.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        txtPessoas.setForeground(new java.awt.Color(33, 150, 243));
        txtPessoas.setText("IDIOMA:");
        ...
        editDiretor.setBackground(new java.awt.Color(187, 187, 187));
        jPCadastrar.add(editDiretor, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 210, 190, 40));
        ...
        txtLocal2.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        txtLocal2.setForeground(new java.awt.Color(33, 150, 243));
        txtLocal2.setText("ANO:");
        jPCadastrar.add(txtLocal2, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 290, -1, -1));

        txtFotografo1.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        txtFotografo1.setForeground(new java.awt.Color(33, 150, 243));
        txtFotografo1.setText("GÊNERO:");
        jPCadastrar.add(txtFotografo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 180, -1, -1));

        editAtores.setBackground(new java.awt.Color(187, 187, 187));
        editAtores.setColumns(20);
        editAtores.setRows(5);
        jScrollPane3.setViewportView(editAtores);
    ...
    private void btnCarregarArquivoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCarregarArquivoMouseClicked
        String path = getPathFile();
        if (path != null) {
            if (gFilmes.carregarArquivo(path)) {
    ...
    private void btnPesquisarMidiaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPesquisarMidiaMouseClicked
        if (editConsultar.getText().trim().equals("")) {
            ...
            Filme aux = (Filme) gFilmes.consultar(editConsultar.getText());
    ...
    private void btnAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddMouseClicked
        if ((editCaminho.getText().trim().equals("") || editTitulo.getText().trim().equals(""))
                || editIdioma.getText().trim().equals("") || editDescricao.getText().trim().equals("")
                || editGenero.getText().trim().equals("") || editDiretor.getText().trim().equals("")
                || editAtores.getText().trim().equals("") || editAno.getText().trim().equals("")) {
    ...
    private void btnAtualizarMidiasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAtualizarMidiasMouseClicked
        if (jTable.getSelectedRow() == -1) {
            ...
            Midia midiaVelha = gFilmes.consultar(tituloMidiaAntiga);
            ...
            if (midiaNova != null) {
                if (gFilmes.editar(midiaVelha, midiaNova)) {
    ...
    private javax.swing.JFormattedTextField editAno;
    private javax.swing.JTextArea editAtores;
    ...
    private javax.swing.JTextField editDiretor;
    ...
    private javax.swing.JLabel txtFotografo1;
    ...
    private javax.swing.JLabel txtLocal2;
